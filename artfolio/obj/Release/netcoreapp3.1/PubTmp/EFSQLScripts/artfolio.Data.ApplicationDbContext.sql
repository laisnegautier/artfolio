...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20200226201607_test')
BEGIN
    ...
    IF @var0 IS NOT NULL EXEC(N'ALTER TABLE [Artists] DROP CONSTRAINT [' + @var0 + '];');
    ALTER TABLE [Artists] ALTER COLUMN [PublicLink] nvarchar(max) NULL;
END;
...
BEGIN
    ...
    ALTER TABLE [Artists] ALTER COLUMN [Name] nvarchar(max) NULL;
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20200226201607_test', N'3.1.2');
END;
